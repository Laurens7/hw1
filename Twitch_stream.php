...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Twitch_stream.css"/>
        <link rel="stylesheet" href="Twitch.css"/>
        <script src="Twitch_stream.js" defer="true"></script>
    ...
    <body>
        <div id='footer'>
            ...
            <section class='libreria'>
                <section class='contenitore_cat'></section>
                <h1 class='canali'>Canali live</h1>
